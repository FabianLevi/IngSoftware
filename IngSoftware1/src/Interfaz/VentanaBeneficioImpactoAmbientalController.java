 ...
 * @author Sabrina
 */
public class VentanaBeneficioImpactoAmbientalController implements Initializable {
    ...
    @FXML
    private BarChart<?, ?> graficaAmbiental;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (int i = 0; i < Main.sistema.getListaEnvasesReutilizables().size(); i++) {
            ...
            int cant = e.getCantVendidas()* e.getEnvase().getDanoAmbiental();
            set1.getData().add(new XYChart.Data(nombre,cant));
        }
        graficaAmbiental.getData().addAll(set1);
    }    
